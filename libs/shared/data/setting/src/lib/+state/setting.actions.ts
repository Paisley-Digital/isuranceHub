...
import { FontSizeEntity, Language, Theme } from './setting.model';
...
export const loadSettingFailure = createAction(
  '[Setting/API] Load Setting Failure',
  props<{ error: any }>()
);
...
export const changeLanguageSuccess = createAction(
  '[Setting/API] Change Language Success'
);

export const changeLanguageFailure = createAction(
  '[Setting/API] Change Language Failure',
  props<{ error: any }>()
);
...
export const changeColorPaletteSuccess = createAction(
  '[Setting/API] Change Color Palette Success'
);
...
export const changeFontSchemeSuccess = createAction(
  '[Setting/API] Change Font Size Success'
);

export const changeFontSchemeFailure = createAction(
  '[Setting/API] Change Font Size Failure',
  props<{ error: any }>()
);
